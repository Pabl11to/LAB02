...
import java.util.Map; // Map es utilizado para dividir los valores y se usen como un valor independiente 
...
public class Calculos {
    ...
    public double media(int[] arreglo) {
        ...
        return suma / arreglo.length; //El comando .lenght toma el dato entero de la longitud del arreglo para utilizarlo
    }
